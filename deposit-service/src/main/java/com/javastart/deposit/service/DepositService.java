...
public class DepositService {
    ...
    public DepositService(DepositRepository repository, AccountServiceClient accountServiceClient,
        ...
        this.depositRepository = repository;
    ...
    public DepositResponseDTO deposit(Long accountId, Long billId, BigDecimal amount) {
        ...
        if (billId != null) {
            ...
            BillRequestDTO billRequestDTO = getBillRequest(amount, billResponseDTO);
        ...
        BillRequestDTO billRequestDTO = getBillRequest(amount, defaultBill);
    ...
    private BillRequestDTO getBillRequest(BigDecimal amount, BillResponseDTO billResponseDTO) {
